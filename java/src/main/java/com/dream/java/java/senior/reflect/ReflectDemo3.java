package com.dream.java.java.senior.reflect;

import com.dream.java.java.senior.reflect.entity.Person;
import com.dream.java.java.senior.reflect.entity.Student;
import com.dream.java.java.senior.reflect.entity.Test;
...
public class ReflectDemo3 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //获取类对象3
        Class<?> personClz3 = Class.forName("com.dream.java.java.senior.reflect.entity.Person");
...
//        showInterfaces();
    ...
    private static void classForName() {
        try {
            // 获取 Class 对象
            Class<?> clz = Class.forName("com.dream.java.java.senior.reflect.entity.Person");
