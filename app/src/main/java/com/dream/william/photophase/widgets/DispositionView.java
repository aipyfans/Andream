...
package com.dream.william.photophase.widgets;
...
import com.dream.william.photophase.utils.Evaluators;
import com.dream.william.photophase.utils.MERAlgorithm;
...
public class DispositionView extends RelativeLayout
        implements OnClickListener, OnLongClickListener, ResizeFrame.OnResizeListener {
    ...
    private void displayFrameSettings(final View v) {
        ...
        View dialogView = LayoutInflater.from(getContext()).inflate(R.layout.phase_frame_settings, null, false);
