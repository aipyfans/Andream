package com.dream.william.view.custom.hencoder.view03.practice;
...
public class Practice12MeasureTextView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float tw1 = paint1.measureText(text1);
        float tw2 = paint2.measureText(text2);

        canvas.drawText(text1, 50, 200, paint1);
        canvas.drawText(text2, 50 + tw1, 200, paint2);
        canvas.drawText(text3, 50 + tw1 + tw2, 200, paint1);
    }
}
