package com.dream.william.view.custom.hencoder;
...
public class HenCoder6Activity extends AppCompatActivity {
    TabLayout tabLayout;
    ViewPager pager;
...

    {
        ...
        pageModels.add(new PageModel(R.layout.sample_scale_exist, R.string.title_scale, R.layout.practice_scale_exist));
